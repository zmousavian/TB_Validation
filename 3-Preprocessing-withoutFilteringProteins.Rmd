...
subtitle: Olink preprocessing-without filtering proteins
---
...
```{r}
clinical_data <- read_excel(path="../Data/Plasma profiling_Feb_2024_final.xlsx",sheet = "More clinical data")
load("../Data/ReadyData/AllDatasets-NPX.RData")
...
```{r}
save(olink,file="../Data/ReadyData-withoutFilteringProteins/ReadyData-discovery.RData")
```
...
```{r}
save(olink,file="../Data/ReadyData-withoutFilteringProteins/ReadyData-portugal.RData")
```
...
```{r}
save(olink,file="../Data/ReadyData-withoutFilteringProteins/ReadyData-third-edta.RData")
```
...
```{r}
save(olink,file="../Data/ReadyData-withoutFilteringProteins/ReadyData-third-heparin.RData")
```
...
names(inputData) <- c("Samples", "Groups", "Proteins", "NPX")
inputData$Groups <- factor(inputData$Groups, levels = c("Baseline","2 Months","6 Months"))

ggplot(inputData,aes(x=Proteins,y=NPX,fill=Groups))+
  geom_boxplot(aes(middle=mean(NPX)),fatten=1,outlier.size = 0.5)+
  scale_fill_manual(values = c("#2F8AC4","#2F8AC4","#2F8AC4"))+
  facet_wrap(~Proteins, scale="free",ncol=8)+
  theme(axis.text=element_text(size=6),
        axis.text.x=element_blank(),
        axis.title = element_text(size=7,face="bold"),
...
```{r}
save(olink,file="../Data/ReadyData-withoutFilteringProteins/ReadyData-third-heparin-followTreatment.RData")
```
...
ggplot(inputData,aes(x=Proteins,y=NPX,fill=Groups))+
  geom_boxplot(aes(middle=mean(NPX)),fatten=1,outlier.size = 0.5)+
  scale_fill_manual(values = c("#A3B574","#9084BB","#D3AC40","#D15472"))+
  facet_wrap(~Proteins, scale="free",ncol=8)+
  theme(axis.text=element_text(size=6),
        axis.text.x=element_blank(),
        axis.title = element_text(size=7,face="bold"),
...
```{r}
save(olink,file="../Data/ReadyData-withoutFilteringProteins/ReadyData-third-heparin-nonTB.RData")
```
...
```{r}
save(olink,file="../Data/ReadyData-withoutFilteringProteins/ReadyData-second-sweden.RData")
```
...
```{r}
save(olink,file="../Data/ReadyData-withoutFilteringProteins/ReadyData-second-italy.RData")
```
